...
with col1:
    ...
    if uploaded_file1:
        ...
        st.image(uploaded_image_preview, caption="Uploaded style image")
    else:
        st.image("images/art_example.png", caption="Default cubist art style image")
...
with col2:
    ...
    if uploaded_file2:
        ...
        st.image(uploaded_image_preview, caption="Uploaded subject image")
    else:
        st.image("images/cat_example.png", caption="Default cat subject image")
...
with col4:
    ...
    if generate_button:
        ...
        st.image(generated_image, caption="Generated style-mixed image")
